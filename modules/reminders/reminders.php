...
if (isset($_GET['delete'])) {
    ...
    // 2. Update Redirect: dashboard.php is in the root
    $redirect = (isset($_GET['from']) && $_GET['from'] == 'dashboard') 
...
if (isset($_GET['toggle'])) {
    ...
    if ($task) {
        if ($task['status'] == 'PENDING') {
            ...
            // CREATE THE NEXT TASK (If Recurring)
    ...
    // Update Redirect: dashboard.php is in the root
    $redirect = (isset($_GET['from']) && $_GET['from'] == 'dashboard') 
                ? BASE_URL . 'dashboard.php' 
                : 'reminders.php';
    header("Location: $redirect");
...
$sql .= " ORDER BY reminder_date ASC, status DESC";

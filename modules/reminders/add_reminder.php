<?php
// modules/reminders/add_reminder.php
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute([$title, $date, $type, $remark])) {
        // 2. Update Redirect: Use BASE_URL to point back to the root dashboard
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="flex items-center gap-4 pt-4">
                ...
                <a href="<?= BASE_URL ?>dashboard.php" class="px-6 py-3 font-bold text-slate-500 hover:text-slate-800 transition-colors">
                    Cancel
                </a>
            </div>

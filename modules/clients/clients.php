...
// 2. Update Path to Header: Point to includes folder
...
<div class="max-w-7xl mx-auto space-y-8 mb-12">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <a href="<?= BASE_URL ?>modules/projects/add_entry.php" class="bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold px-5 py-2.5 rounded-xl shadow-lg shadow-slate-900/20 transition-all transform active:scale-95 flex items-center justify-center gap-2 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        ...
                        <td class="p-5 text-right pr-6">
                            <a href="<?= BASE_URL ?>modules/clients/client_view.php?id=<?= $c['client_id'] ?>" class="group/btn inline-flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-blue-600 transition-colors bg-slate-50 hover:bg-blue-50 px-3 py-2 rounded-lg border border-slate-100 hover:border-blue-100">
...
<?php 
// 5. Update Path to Footer: Point to includes folder

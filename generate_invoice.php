...
if ($is_edit) {
    ...
    // Detection logic: Check database column 'service_type' first, fallback to number string
    ...
    if (!$client_id) header("Location: dashboard.php");
...
// --- FILTERED FETCHING BASED ON TYPE & LEAD TIMES ---
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        // --- NEW LOGIC: Calculate Billing Period (Financial Year Session) ---
        ...
        // Determine the permanent Service Type Flag
        $type_flag = 'GEN';
        ...
        // Final Update including billing_period and service_type

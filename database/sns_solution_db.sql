...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 03, 2026 at 02:33 PM
...
(4, 'Sun & Sun Group', 'Raipur', '', '', 'INHOUSE', '2026-01-03 06:08:45'),
(5, 'Panini Foundation', '', '', '', 'OUTHOUSE', '2026-01-03 13:06:47');
...
(8, 'SNS/15', 1, '2026-01-01', 15000.00, 'P', NULL, '2025-2026', NULL, '2026-01-02 11:45:44'),
(9, 'SNS/SM/014', 1, '2025-12-31', 10900.00, 'SM', NULL, '2025-2026', NULL, '2026-01-03 05:45:37'),
(10, 'SNS/16', 4, '2026-01-16', 3000.00, 'P', NULL, '2025-2026', NULL, '2026-01-03 06:08:55'),
(11, 'SNS/17', 5, '2025-09-16', 3500.00, 'P', NULL, '2025-2026', NULL, '2026-01-03 13:06:54');
...
(95, 9, 'Social Media Management Charge', 7500.00, 1),
(96, 9, 'Gold Rate Video', 3400.00, 17),
(99, 10, 'sunandsungroup.com', 3000.00, 1),
(100, 8, 'SNSJ Billing App', 15000.00, 1),
(102, 11, 'paninifoundation.org', 3500.00, 1);
...
(4, 1, 'SNSJ Billing App', 'Web App', 15000.00, 0.00, '2027-01-01', 'Dhiraj Soni , Yogesh', '9516536692 , 8962045', 'PHP', '5.0'),
(5, 4, 'sunandsungroup.com', 'Website', 3000.00, 0.00, '2027-01-16', 'Nirmarkar Sir', '7828728780', 'PHP', '5.0'),
(6, 5, 'paninifoundation.org', 'Website', 3500.00, 0.00, '2026-09-16', 'Bhaskar Ji', '9752475808', 'PHP', '7.0');
...
--
ALTER TABLE `smm_services`
  MODIFY `smm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

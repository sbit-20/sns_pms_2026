...
<div class="print-container bg-white w-[210mm] shadow-xl relative text-slate-900 box-border mx-auto flex flex-col">
    ...
    <?php if (!empty($rec['receipt_file']) && file_exists($rec['receipt_file'])): ?>
    <div class="border-t-black p-4 mt-4 page-break-before">
        <a href="<?= $rec['receipt_file'] ?>" target="_blank" class="bg-slate-800 text-white px-4 py-2 rounded text-xs font-bold hover:bg-black">View Acknowledgement</a>
    </div>
    <?php endif; ?>
